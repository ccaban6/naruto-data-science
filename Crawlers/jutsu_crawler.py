...
class BlogSpider(scrapy.Spider):
    ...
    def parse_justu(self, response):
        ...
        if soup.find('div', {'id': 'quiz_module_desktop_header_styles'}):
            soup.find('div', {'id': 'quiz_module_desktop_header_styles'}).decompose()

        if soup.find('div', {'id': 'quiz_module_desktop_link_styles'}):
            soup.find('div', {'id': 'quiz_module_desktop_link_styles'}).decompose()
